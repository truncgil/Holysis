...
<?php $types = Types::whereNull("kid")->orderBy("s","ASC")->get(); ?>
 <div class="content-side content-side-full">
                    ...
                    <ul class="nav-main">
                        <li>
                            <a class="active" href="<?php echo e(url('admin/')); ?>"><i class="si si-cup"></i><span
                                    class="sidebar-mini-hide"><?php echo e(__('Özet')); ?></span></a>
                        </li>
					
						<li class="nav-main-heading d-none"><span class="sidebar-mini-visible">UI</span><span
                                class="sidebar-mini-hidden"><?php echo e(__('İçerik Türleri')); ?></span></li>
						...
						<li class="nav-main-heading "><span class="sidebar-mini-visible">UI</span><span
                                class="sidebar-mini-hidden"><?php echo e(__('İçerik Ağacı')); ?></span></li>
					...
					<ol class="tree">
						...
						$(function(){
							$(".kategori-tree").on("click",function(){
								console.log("ok");
								var bu = $(this);
								bu.parent().children("ol").html("<?php echo e(__('Bekleyiniz...')); ?>"); 
						...
						<li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span
                                class="sidebar-mini-hidden"><?php echo e(__('İçerik Yönetimi')); ?></span></li>
                        <li>
                            <a class="nav-submenu" href="<?php echo e(url('admin/new/contents')); ?>"><i class="si si-grid"></i><span
                                    class="sidebar-mini-hide"><?php echo e(__("İçerikler")); ?></span></a>
                          
                        </li>
                        <li>
                            <a class="nav-submenu" href="<?php echo e(url('admin/new/types')); ?>"><i
                                    class="si si-layers"></i><span class="sidebar-mini-hide"><?php echo e(__('Türler')); ?></span></a>
                            
                        </li>
                        <li>
                            <a class="nav-submenu" href="<?php echo e(url('admin/fields')); ?>"><i class="si si-list"></i><span
                                    class="sidebar-mini-hide"><?php echo e(__('Alanlar')); ?></span></a>
                        ...
                        <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span
                                class="sidebar-mini-hidden"><?php echo e(__('Dil Ayarları')); ?></span></li>
							
							<?php 	$diller = explode(",","en,de"); foreach($diller AS $d) { ?>
							<li>
                ...
                </div><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/inc/menu.blade.php ENDPATH**/ ?>