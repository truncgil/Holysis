...
<head>	
    ...
    <title><?php echo strip_tags($__env->yieldContent('title','OTTO2020')); ?></title>
    ...
    <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e(asset('assets/favicon.png')); ?>">
    <link rel="apple-touch-icon" sizes="512x512" href="<?php echo e(asset('assets/favicon.png')); ?>">
                    ...
                    <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                        ...
                        <div class="content-header-item">
                            <a class="link-effect font-w700" href="#">
                                <img id="mainLogo" width="100%" style="        max-width: 70px;;" data-theme="light" src="<?php echo e(asset('assets/img/logo.svg')); ?>" class="h-full-w-auto" alt="Trunçgil Teknoloji">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-header-section">
                    <div class="btn-group" role="group">
                        ...
                        <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-user d-sm-none"></i>
                            <span class="d-none d-sm-inline-block"><?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->surname); ?></span>
                            <!-- Kullanıcı adı -->
                            <i class="fa fa-angle-down ml-5"></i>
                        </button>
				...
				<div class="bg-image" >
					<div class="bg-white-op-90">
						<div class="content content-full content-top">
							...
							<div class="text-center"><?php echo $__env->yieldContent("desc"); ?></div>
						</div>
					</div>
				</div>
				<?php endif; ?>
...
</style><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/master.blade.php ENDPATH**/ ?>