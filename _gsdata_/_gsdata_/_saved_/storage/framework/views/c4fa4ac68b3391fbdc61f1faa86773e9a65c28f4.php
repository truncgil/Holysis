...
<div class="block">
	...
	<div class="block-content block-content-full ana-icerik">
		...
		<form action="<?php echo e(url('admin-ajax/content-update?back')); ?>" method="post">
		<?php echo e(csrf_field()); ?>
    ...
    color: #f3f3f3;"></i>
		...
		<form action="<?php echo e(url('admin-ajax/files-upload')); ?>" id="files<?php echo e($c->id); ?>" class="dropzone" id="dropzone" enctype="multipart/form-data" method="post">
							<div class="fallback">
							  ...
							  <?php if($c->files!=""): ?> 
								  ...
								  <div file="<?php echo e($f); ?>" class="dz-preview dz-file-preview dz-processing dz-error dz-complete">  
									  ...
									  <div class="dz-filename"><span data-dz-name=""><?php echo e($f); ?></span></div>  </div>  
						...
						<script type="text/javascript">
						$(function(){
							$(".dropzone").dropzone({ url: "<?php echo e(url('admin-ajax/files-upload')); ?>",
								resizeWidth:1024,
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/contents.blade.php ENDPATH**/ ?>