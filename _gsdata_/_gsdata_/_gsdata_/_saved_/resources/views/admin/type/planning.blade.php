...
if(getisset("process")) {
	...
	$(function(){
		$("#nav-board").load("?ajax2=admin.type.planning.board&w={{get("w")}}",function(){
...
<div class="load-zone d-none" style="position:fixed;top:50px;right:20px; width:200px">
	<div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 100%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
		<span class="progress-bar-label">{{e2("Please Wait")}}</span>
	</div>
</div>
<div class="content">
	<div class="block">
			...
			<ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
				<li class="nav-item">
					<a class="nav-link @if(1==$active) active @endif" onclick="$('#nav-board').load('?ajax2=admin.type.planning.board')" href="#nav-board">{{e2("Planning Board")}}</a>
				</li>
				
				<li class="nav-item">
					<a class="nav-link @if(2==$active) active @endif" href="#nav-sap">
						{{e2("SAP")}}
					</a>
				</li>
			</ul>
			<div class="block-content tab-content">
				<div class="tab-pane @if(1==$active) active @endif" id="nav-board" role="tabpanel">
					
						
					
				</div>
				<div class="tab-pane @if(2==$active) active @endif" id="nav-sap" role="tabpanel">
					
						@include("admin.type.planning.sap")
