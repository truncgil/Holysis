...
$contents = Contents::where("kid",$p['id'])
	...
	<?php if($contents->count()!=0) { ?>
		...
		foreach($contents AS $c) {
			...
			?>
			<li>
								<label for="menu-<?php echo($c->id) ?>" onclick="location.href='<?php echo e(url("admin/contents/".$c->id)); ?>'" ><?php e2($c->title) ?></label>
...
<script type="text/javascript">
 ...
 <?php
$return = null;
 ?><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin-ajax/contents-tree.blade.php ENDPATH**/ ?>