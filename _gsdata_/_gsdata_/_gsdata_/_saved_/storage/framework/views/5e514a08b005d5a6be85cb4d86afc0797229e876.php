				...
				<form action="" method="get">
					<input type="text" name="q" class="form-control" value="<?php echo e(get("q")); ?>"  placeholder="Ara..."  /> <br />
						...
						<table class="table table-bordered table-hover table-striped " id="ceviri-table">
							...
							<?php endif; ?>
								<td>
									<a href="" onclick="$(this).parent().parent().remove(); return false" class="btn btn-danger" title="<?php echo e(__('Bu satırı sil')); ?>"><i class="fa fa-times"></i></a>
								</td>
							</tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/languages.blade.php ENDPATH**/ ?>