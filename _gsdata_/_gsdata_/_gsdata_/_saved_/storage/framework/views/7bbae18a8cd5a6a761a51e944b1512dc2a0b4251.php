								...
								<div class="form-group row" id="t<?php echo e($a->id); ?>">
									<div class="col-12">
										...
										<?php if($c->title=="Ofen"): ?>
											...
											<input type="date" class="form-control form-control-lg edit" placeholder="<?php echo e(e2("Date")); ?>" name="date" id="<?php echo e($a->id); ?>" table="contents"  value="<?php echo e($a->date); ?>">
										<?php endif; ?>
										<?php if($c->title=="Shift Hours"): ?>
											<input type="time" class="form-control form-control-lg edit" placeholder="<?php echo e(e2("Min Hour")); ?>" step="any" name="time1"  id="<?php echo e($a->id); ?>" table="contents"  max="<?php echo e($a->time1); ?>" value="<?php echo e($a->time1); ?>">
											<input type="time" class="form-control form-control-lg edit" placeholder="<?php echo e(e2("Max Hour")); ?>" step="any"  name="time2" onblur="$(this).next().attr('max',$(this).val()).prop('max',$(this).val());" id="<?php echo e($a->id); ?>" table="contents"  value="<?php echo e($a->time2); ?>">
...
</div><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/type/configuration.blade.php ENDPATH**/ ?>