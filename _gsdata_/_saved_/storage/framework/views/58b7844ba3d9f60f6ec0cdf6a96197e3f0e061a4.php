...
<?php
	...
	$seviye = explode(",","Admin,Head Of Department,Workstation Chief,Worker");
	$request = null;
	if(Input::has("q")) {
		  $request = Request::all();
		  $q = $request['q'];
		...
		$users = User::orderBy("id","DESC")->where("id",">=",Auth::user()->id)->simplePaginate(10);
	}
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euro/otto2020.euro.kim/resources/views/admin/users.blade.php ENDPATH**/ ?>