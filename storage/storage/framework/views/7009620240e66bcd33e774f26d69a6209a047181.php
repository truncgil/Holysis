...
?>
<!DOCTYPE html>
<html dir="ltr" class="android device-pixel-ratio-1 theme-light color-theme-yellow">
  <head>
    <!-- Required meta tags-->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo e(url("assets/sphyzer.css")); ?>">
  </head>
  <body>
    <!-- App root element -->
    <div id="app">
    ...
    <!-- Path to your app js-->
    <script type="text/javascript" src="<?php echo e(url("assets/sphyzer.js")); ?>"></script>
  </body>
</html>
...
<?php /**PATH /home/sphyzer/app/resources/views/layouts/app.blade.php ENDPATH**/ ?>