                    ...
                    <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                        ...
                        <div class="content-header-item">
                            <a class="link-effect font-w700" href="#">
                                <img id="mainLogo" width="100%" style="        max-width: 100px;" data-theme="light" src="<?php echo e(asset('assets/img/logo.svg')); ?>" class="h-full-w-auto" alt="Trunçgil Teknoloji">
                            </a>
                        </div> 
                    </div>
                </div>
...
<style type="text/css">
		...
		.table-responsive {
            background: url(https://app.sphyzer.com/assets/back.png) white center center / contain no-repeat !important;
...
</script> <?php /**PATH /home/sphyzer/app/resources/views/admin/master.blade.php ENDPATH**/ ?>