...
?>
    <title><?php echo e($ogrenci_title); ?> Taksonomik Düzey Raporu</title>
</head>

<body>
<nav class="navbar navbar-light bg-light navbar-expand-lg print-none">
  <a class="navbar-brand" href="#">
        <img src="<?php echo e($logo); ?>" style="width:200px;margin:0 10px;" alt="">
  </a>
  <strong><?php echo e($ogrenci_title); ?> <?php echo e(e2("Taksonomik Analiz Raporu")); ?></strong>
            ...
            <div class="col-10">
                ...
                <table class="table text-center table-bordered">
                    ...
                    <tr>
                        ...
                        <th><?php echo e($col_k); ?></th>
                        <?php } ?>
                    </tr>
                    <?php } ?>
                    <tr>
                        <th><?php echo e($col[$row_k]); ?></th>
                        <?php for($col_k=1;$col_k<=6;$col_k++) { ?>
                        ...
                        <td>
                            ...
                            <div class="progress">
                            <div class="progress-bar bg-danger" style="width:<?php echo e($yanlis_yuzde); ?>%">

                                    %<?php echo e($yanlis_yuzde); ?>

                                </div>
                                <div class="progress-bar bg-warning" style="width:<?php echo e($bos_yuzde); ?>%">

                                    %<?php echo e($bos_yuzde); ?>

                                </div>
                                <div class="progress-bar bg-success" style="width:<?php echo e($dogru_yuzde); ?>%">

                                    %<?php echo e($dogru_yuzde); ?>
...
</html><?php /**PATH /home/dijimind/app/resources/views/admin-ajax/taksonomik-duzey-rapor.blade.php ENDPATH**/ ?>