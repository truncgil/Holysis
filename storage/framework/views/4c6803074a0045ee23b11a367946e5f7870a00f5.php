...
<table border="1">
    ...
    <tr>
        ...
        <td><?php echo e($k); ?></td>
        <td><?php echo e(@$kazanim[$slug.'_b_soru_no_'.$k]); ?></td>
        <td>
        <?php 
        if(is_array($cevap)) {
            foreach($cevap AS $c) {
        ...
        <td><?php echo e(@$kazanim[$slug.'_kazanim_'.$k]); ?></td>
        <td><?php echo e(@$kazanim[$slug.'_tak_'.$k]); ?></td>
        <td><?php echo e(@$kazanim[$slug.'_c_soru_no_'.$k]); ?></td>
        <td><?php echo e(@$kazanim[$slug.'_d_soru_no_'.$k]); ?></td>
    </tr>
    <?php } ?>
    <?php } ?>
</table>
...
<?php exit(); ?><?php /**PATH /home/dijimind/app/resources/views/admin-ajax/kazanim-excel-export.blade.php ENDPATH**/ ?>