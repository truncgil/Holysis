...
<?php
	...
	$seviye = explode(",","Admin,Kurum,Öğretmen,Öğrenci,Moderatör,Ziyaretçi");
	$request = null;
	if(Input::has("q")) {
		  $request = Request::all();
		  $q = $request['q'];
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dijimin2/hacksmarcity/resources/views/admin/users.blade.php ENDPATH**/ ?>