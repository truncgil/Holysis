...
<?php } ?>
					<a class="btn-block-option" href="<?php echo e(url("admin/contents/".$a->id."")); ?>" target="_blank" title="<?php echo e($a->title); ?> <?php echo e(e2("Düzenle")); ?>">
		...
		</div><?php /**PATH /home/dijimin2/hacksmarcity/resources/views/admin/inc/block.blade.php ENDPATH**/ ?>