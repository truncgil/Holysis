<div class="content">
    <div class="block">
            <div class="block-header block-header-default" >
                <h3 class="block-title"><i class="fa fa-plus"></i> <?php echo e(e2("Yeni Sınav")); ?></h3>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach($branslar AS $b) {
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="ders[]" value="<?php echo e($b->title); ?>">
                                <input type="hidden" name="ders_slug[]" value="<?php echo e($b->slug); ?>">
                                <td><input type="number" name="<?php echo e($b->slug); ?>_soru" id="" class="form-control"></td>
                                <td><input type="number" name="<?php echo e($b->slug); ?>_optik" id="" class="form-control"></td>
                                <td><input type="number" name="<?php echo e($b->slug); ?>_carpan" id="" class="form-control"></td>
                            </tr>
                            <?php 
                        } ?>
                    </table>
   
                    <button class="btn btn-primary"><i class="fa fa-save"></i> <?php echo e(e2("Kaydet")); ?></button>
                </form>

            </div>
    </div>
</div>
    <?php /**PATH /home/dijimind/app/resources/views/admin/type/sinavlar/yeni-sinav.blade.php ENDPATH**/ ?>