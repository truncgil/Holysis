<?php
mkdir("/home/dijimin2/hacksmarcity/sessions",true);
session_save_path('/home/dijimin2/hacksmarcity/sessions');
...
function branslar() {
    $brans = db("contents")->select("id","title")->where("type","Branşlar")->get();
    return $brans;
}
function kazanimlar() { //önceden girilmiş olan kazanimları listeler
    $sorgu = db("soru_bankasi")->get("kazanim");

    return $sorgu;
}
function konular() { //önceden girilmiş olan kazanimları listeler
    $sorgu = db("soru_bankasi")->get("konu");
